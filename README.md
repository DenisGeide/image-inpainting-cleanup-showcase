...
- [configs/comfyui-inpainting-workflow.example.json](configs/comfyui-inpainting-workflow.example.json)

This file documents the workflow structure and key node values without including private local paths or model files.
